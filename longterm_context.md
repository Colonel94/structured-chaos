...
score.py now flags timeout/empty rows loudly. 222 tests +1 skip, ruff/black/mypy(app)+UI tsc clean. **The
portal now REQUIRES a running worker.** Next: real-iPhone voice test → 3 strangers.)*
...
>
> **GIT:** tree clean, **19 migrations, 222 tests +1 skip**, ruff/black/mypy(app) + UI tsc clean. (Pushed link shared in chat after commit.)
>
